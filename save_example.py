...
x1 = np.linspace(-4000,4000,2500)
y1 = spectra[0](x1) 
y1 += np.abs(np.random.randn(x1.shape[0]) * np.sqrt(y1))

x2 = np.linspace(-4000,4000,2500)
y2 = spectra[1](x2) 
...
np.savetxt('data1_1.csv', np.column_stack((x1,y1)))
np.savetxt('data2_1.csv', np.column_stack((x2,y2)))


a = Analysis(['data1_1.csv', 'data2_1.csv'])
